...
public class ModEmpleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/modempleado- banner.png"))); // NOI18N
    ...
    private void txtIngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtIngresarMouseClicked
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "¡El empleado fue modificado existosamente!");
