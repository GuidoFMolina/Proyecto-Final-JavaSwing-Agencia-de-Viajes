...
public class NewUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnVolverLogin.setFont(new java.awt.Font("Roboto", 1, 10)); // NOI18N
        btnVolverLogin.setForeground(new java.awt.Color(153, 153, 255));
        ...
        btnVolverLogin.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnVolverLoginMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnVolverLoginMouseExited(evt);
            }
        });
        ...
        btnAltaLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btnAltaLayout.createSequentialGroup()
                ...
                .addComponent(txtIngresar, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void txtIngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtIngresarMouseClicked
        ...
        //Instanciar empleado y setear sus atributos con los extraidos del front
         Empleado empleado = new Empleado();
            ...
            empleado.setId((long)control.listarEmpleado().size());
          
            //Instanciar usuario con los atributos extraidos del front
            Usuario usuario = new Usuario();
            usuario.setNombre_usuario(nombre_usuario);
            usuario.setContrasenia(contrasenia);
            usuario.setId((long)control.listarUsuario().size());
    ...
    private void btnAltaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAltaMouseClicked
        //Repetimos procedimiento de alta por algun caso de falla de clickeo
        //Poner en variables los atributos de empleado
        String nombre_empleado = txtNombre.getText();
        String apellido_empleado = txtApellido.getText();
        String dni = txtDNI.getText();
    ...
    private void btnVolverLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVolverLoginMouseClicked
      //Si presiona el usuario el texto [Volver al login] se dara acceso al mismo
    ...
    private void btnVolverLoginMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVolverLoginMouseEntered
        btnVolverLogin.setForeground(Color.blue);
    }//GEN-LAST:event_btnVolverLoginMouseEntered

    private void btnVolverLoginMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVolverLoginMouseExited
        btnVolverLogin.setForeground(new Color(153, 153, 225));
    }//GEN-LAST:event_btnVolverLoginMouseExited
