...
public class ModCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/modificar cliente - banner.png"))); // NOI18N
    ...
    private void btnIngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIngresarMouseClicked
        long id = Long.parseLong(JOptionPane.showInputDialog("Ingrese el ID del cliente que desea modificar:"));
       ...
       try{
        ...
        control.modificarCliente(cliente);
           JOptionPane.showMessageDialog(null, "¡El Cliente "+nombre+" "+apellido+" se ha modificado con éxito!");
       }catch(Exception e){
